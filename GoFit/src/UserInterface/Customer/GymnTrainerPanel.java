...
import Business.WorkQueue.GymnTrainerWorkRequest;
 ...
 * @author rutujakute
 */
public class GymnTrainerPanel extends javax.swing.JPanel {
    ...
    Enterprise e;
    public GymnTrainerPanel(JPanel userProcessContainer, Ecosystem system, Network network, UserAccount userAccount) {
        initComponents();
        initComponents();
      ...
      private void populateGymnStatusTable() {
        ...
        if (org!=null){
            ...
            row[3] = ((GymnTrainerWorkRequest)request).getGymnTrainerResult();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(userAccount.getWorkQueue().getWorkRequestList().size()== 0){
            GymnTrainerWorkRequest req = new GymnTrainerWorkRequest();
