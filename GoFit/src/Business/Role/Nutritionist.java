...
import UserInterface.Nutritionist.NutritionistWorkAreaPanel;
...
public class Nutritionist extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, Enterprise enterprise, Organization organization, UserAccount account, Ecosystem business, Network network) {
        return new NutritionistWorkAreaPanel(userProcessContainer, enterprise, organization, account, business, network);
    }
